...
public final class NavHeaderMainBinding implements ViewBinding {
  ...
  private NavHeaderMainBinding(@NonNull LinearLayout rootView, @NonNull ImageView imageView,
      @NonNull TextView viewUserEmail, @NonNull TextView viewUserName) {
  ...
  public static NavHeaderMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.view_user_email;
      TextView viewUserEmail = ViewBindings.findChildViewById(rootView, id);
      if (viewUserEmail == null) {
        break missingId;
      }

      id = R.id.view_user_name;
      TextView viewUserName = ViewBindings.findChildViewById(rootView, id);
      if (viewUserName == null) {
        break missingId;
      }

      return new NavHeaderMainBinding((LinearLayout) rootView, imageView, viewUserEmail,
          viewUserName);
    }
