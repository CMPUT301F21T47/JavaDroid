...
public class FriendRequestsFragment extends Fragment {
    ...
    /**
     * Asks the user to accept or decline a friend request
     * @param friend the information of the friend request sender
     */
    private void showAcceptFriendDialog(Friend friend){
