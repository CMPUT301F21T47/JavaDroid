    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        habitAdapter.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(int position) {
                ...
                viewFriendHabit(habit);
            }
        });
    }

    /**
     * Start an activity to view details of a friend's habit
     * @param habit a user selected habit of a user's friend
     */
    private void viewFriendHabit(Habit habit){
        ...
        intent.putExtra("control_code", 1); // indicates that we start ViewHabitActivity as a friend not a host
